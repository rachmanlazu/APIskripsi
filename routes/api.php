...
Route::group(['middleware' => 'auth:api'], function(){
    ...
    Route::get('pasien/getAntrian', 'API\ReservasiController@getAntrian')->name('pasien.getAntrian');
    ...
    Route::get('pasien/getRiwayatPembelian', 'API\ReservasiController@getRiwayatPembelian')->name('pasien.getRiwayatPembelian');
});
